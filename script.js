...
const veryOldInventors = inventors.filter((person) => {
...
let isEveryone19OrOlder = devs.every((people) => {
    return people.year > 2003;
})
...
let commentById = comments.find((specific ) => {
    return specific.id === 823423;
})
